...
function App() {
  ...
  <section className="hero-section">
    <div className="nav-container">
      <img src="./assets/Logo.png" alt="Nav-logo Image" className="nav-logo" />
      {/* <i class="fa-solid fa-bars"></i> */}
      <p className="nav-url">My URLs</p>
      <p className="nav-features">
        <a href="#Why-scissor">Features </a>
        <img src="./assets/Vector.png" alt="Arrow down Image" />
      </p>
    ...
    <main>
      ...
      <img src="./assets/Vector 3.png" alt="Vector Image" width="164px" />
    </main>
    ...
    <div>
      <img src="./assets/Group 2.png" alt="Image" className="group" />
    </div>
    <div>
      <img
        ...
        height="84px"
      />
      <img src="./assets/Ellipse 1.png" alt="An ellipse" className="ellipse" />
    </div>
  </section>
  {/* Desktop Section */}
  <section>
    ...
    <div className="scissor-container">
      ...
      <div>
        <img src="./assets/Ellipse 2.svg" alt="" className="scissor-ellipse" />
    ...
    <div className="footer-wrapper">
      ...
      <div className="footer-body">
        ...
        <div>
          <h4>Legal</h4>
          <p>
            Privacy Policy Cookie Policy Terms of Service Acceptable Use Policy
            Code of Conduct
          </p>
        </div>
      </div>
